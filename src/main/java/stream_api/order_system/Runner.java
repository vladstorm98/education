...
public class Runner {
    public static void main(String[] args) {
        ...
        // 1. Найти клиентов, у которых суммарная стоимость заказов > заданное значение (например, > 1300)
        // 2. Сгруппировать заказы по месяцам и вычислить общую выручку за каждый месяц
        // 3. Определить топ-3 самых популярных товара (по суммарному количеству)
